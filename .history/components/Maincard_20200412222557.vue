<template>
  ...
  >
    ...
    <div>
      ...
      <div
        class="flex text-xs mt-2 text-gray-500 border-b border-gray-200 pb-4 lg:border-0"
      >
    ...
    <!-- Tags -->
    <div class="mt-4 flex flex-wrap justify-start lg:justify-end lg:items-center">
      <div
