<template>
  <div
    class="flex flex-col lg:flex-row lg:justify-between flex-no-wrap rounded-sm px-5 bg-white shadow-xl pb-4 mb-10 border-l-4 border-white"
  ...
  >
    ...
    <div>
      ...
      <div
        class="flex text-xs mt-2 mb-4 text-gray-500 border-b border-gray-200 pb-4 lg:border-0"
      >
    ...
    <!-- Tags -->
    <div class="flex flex-wrap justify-start lg:justify-end lg:items-center align-middle">
      <div
